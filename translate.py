...
VI_CHARS = set("aabccddeeghiklmnnopqrsttuvxy")

def is_vietnamese(text):
    vi = set("àáâãèéêìíòóôõùúýăđơư")
    return any(c in vi for c in text.lower())

def call_google(text):
    params = {"client": "gtx", "sl": "auto", "tl": "vi", "dt": "t", "q": text}
    headers = {"User-Agent": random.choice(USER_AGENTS), "Referer": "https://translate.google.com/"}
